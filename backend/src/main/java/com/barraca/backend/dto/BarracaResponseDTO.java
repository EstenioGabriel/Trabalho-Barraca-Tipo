...
public class BarracaResponseDTO {
    ...
    public BarracaResponseDTO(Long id, String nome, String descricao, String localizacao, boolean ativo, Long tipoBarracaId, String tipoBarracaNome) {
        this.id = id;
        this.nome = nome;
    ...
    public String getTipoBarracaNome() {
        return tipoBarracaNome;
    }

    public void setTipoBarracaNome(String tipoBarracaNome) {
        this.tipoBarracaNome = tipoBarracaNome;
    }
}
